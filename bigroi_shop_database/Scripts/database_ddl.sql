CREATE TABLE `PRODUCT` (
  ...
  `CRTD_TMS` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `PURCHASE_ORDER` (
  ...
  `CRTD_TMS` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `UPDT_TMS` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `PURCHASE_ORDER_PRODUCT` (
  `ORDER_ID` int(11) NOT NULL COMMENT 'ÐÐ¾Ð´ Ð·Ð°ÐºÐ°Ð·Ð°',
  `PRODUCT_CODE` int(11) NOT NULL COMMENT 'ÐÐ¾Ð´ ÑÐ¾Ð²Ð°ÑÐ°',
  `PRODUCT_QUANTITY` int(11) NOT NULL COMMENT 'ÐÐ¾Ð»Ð¸ÑÐµÑÑÐ²Ð¾ (ÐµÐ´Ð¸Ð½Ð¸Ñ) ÑÐ¾Ð²Ð°ÑÐ°',
  `PRODUCT_PRICE` decimal(10,0) DEFAULT NULL COMMENT 'Ð¦ÐµÐ½Ð° ÐµÐ´Ð¸Ð½Ð¸ÑÑ ÑÐ¾Ð²Ð°ÑÐ°',
  `DISCOUNT` decimal(10,0) NOT NULL DEFAULT '0' COMMENT 'Ð¡ÐºÐ¸Ð´ÐºÐ° Ð² %',
...
CREATE TABLE `USER` (
  ...
  `UPDT_TMS` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
